...
class ParseAppModelTest {
	...
	void "parse mandatory arguments"() {
		...
		AppModel model = injector.getInstance(CliParser).parse(args)
	...
	static Injector injector = Guice.createInjector(new CliModelModule(), new CoreResourcesModule())
